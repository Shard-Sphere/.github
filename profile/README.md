...
**Arquivos relacionados:** `front · core/crypto/vault-key.ts`, `core/recovery-phrase/*`
...
**Arquivos relacionados:** `front · core/placement.ts`, `core/raid*.ts`, `presenter/components/sidebar/*`
...
**Arquivos relacionados:** `front · core/pipeline*.ts`, `core/raid-put.ts`, `core/crypto/*`
...
**Arquivos relacionados:** `front · core/folder-store.ts`, `core/manifest-store.ts`, `core/index-driver.ts`
...
**Arquivos relacionados:** `server · src/share/*` · `front · components/share-dialog.tsx`
...
**Arquivos relacionados:** `front · ai/*`, `core/labels-store.ts`, `presenter/routes/labels.tsx`
...
| [.github](https://github.com/Shard-Sphere/.github) | Este — visão geral do projeto. |
